...
|---|---|---|---|
| RAG / busca vetorial | `IA Bot Agent/V2 - IA Bot Agent/api/_opcao4` | Usa `pgvector` no Postgres compartilhado (tabelas `rag_documents`, `rag_avaliacao`) | **Não replicar** o Chromadb do projeto antigo (mesma pasta, um nível acima, em `api\`) — ficou obsoleto. `_opcao4` é a evolução. |

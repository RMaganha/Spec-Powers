...
| F-017 | 2026-09-02 | quando o conteúdo de uma página gerada só aparecer se o JS inline rodar | tela vazia pro owner | `body.js` gateia o esconder em `templates/bpmn.py` (sem JS, tudo visível; índice vira âncora) · `test_desenho_visivel_sem_js` + `test_indice_navega_sem_js` | fechado |

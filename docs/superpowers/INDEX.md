...
6. [diagnóstico disciplinado](../specs/diagnostico.md) — trilho anti-loop de hipóteses (F-015, as 6 rodadas do 503 no MSS-SSC) — **entregue na `feature/diagnostico`**, aguarda release

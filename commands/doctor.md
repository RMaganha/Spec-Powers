...
9. **Versão do kit — instalada × publicada no remoto** (sempre, por último — diagnóstico do plugin, não conserta). Diz se o `mss-spec` instalado (global, no `~/.claude`) está atrás do publicado, pra o owner/time saber de qualquer projeto. **Só reporta** — não roda `marketplace update`, não bloqueia.

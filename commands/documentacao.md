...
4. **Arquivo único, self-contained** (é a exceção à regra de separar CSS/JS — doc portável que abre direto no navegador). Salve em `docs/<nome>.html` (ou onde eu indicar). Nada de arquivos `.css`/`.js` à parte.

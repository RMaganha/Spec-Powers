...
4. **link morto no INDEX no nível médio (padrão)** — `nova-feature` registra `specs/<arquivo>-design.md`, mas no médio não nasce doc de spec. Formato da linha deve variar por nível. **RESOLVIDO (2026-07-16)**: kit adotou spec **viva por assunto** (`docs/specs/<assunto>.md`), que existe em todo nível ≥ médio → o link do INDEX é sempre válido (`../specs/<assunto>.md`). Ver `docs/superpowers/specs/2026-07-16-spec-viva-por-assunto-design.md`.
